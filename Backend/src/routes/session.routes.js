...
router.get('/my/all', verifyJWT, queryValidation.pagination, handleValidationErrors, getUserSessions);
router.post('/save-draft', verifyJWT, createSessionLimiter, sessionValidation.create, handleValidationErrors, saveDraftSession);
router.post('/publish', verifyJWT, sessionValidation.publish, handleValidationErrors, publishSession);
